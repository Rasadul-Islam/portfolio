...
const Contact = () => {
  return (
    <motion.div 
      ...
      className="max-w-6xl mx-auto my-20 px-8 py-10 bg-gradient-to-r from-purple-400 to-blue-600 shadow-xl rounded-xl text-gray-800 border border-gray-300"
    >
      {/* Heading */}
      ...
      <div className="space-y-6">
        {contactInfo.map((contact, index) => (
          <motion.div
            ...
            className="max-w-3xl mx-auto flex items-center space-x-6 p-4 rounded-lg bg-white shadow-md shadow-teal-200 hover:shadow-lg hover:bg-gray-200 transition duration-300"
          >
            {contact.icon}
            <div>
